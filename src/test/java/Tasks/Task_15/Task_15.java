...
import Tasks.Task_15.Pojo.ResourceList.Root;
import Tasks.Task_15.Pojo.SingleResource.Resource;
import Tasks.Task_15.Pojo.SingleUser.SingleUser;
import Tasks.Task_15.Pojo.UserList.Datum;
import Tasks.Task_15.Pojo.UserList.UserList;
...
public class Task_15 {
    ...
    public String readFilesAsString(String fileName) {
        try {
            return new String(Files.readAllBytes(Paths.get("src/test/java/Tasks/Task_15/Request/" + fileName + ".json")));
        } catch (IOException e) {
            e.printStackTrace();
        }
        return "";
