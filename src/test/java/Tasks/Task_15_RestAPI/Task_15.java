package Tasks.Task_15_RestAPI;

import Tasks.Task_15_RestAPI.Pojo.ResourceList.Root;
import Tasks.Task_15_RestAPI.Pojo.SingleResource.Resource;
import Tasks.Task_15_RestAPI.Pojo.SingleUser.SingleUser;
import Tasks.Task_15_RestAPI.Pojo.UserList.Datum;
import Tasks.Task_15_RestAPI.Pojo.UserList.UserList;
...
public class Task_15 {
    ...
    public String readFilesAsString(String fileName) {
        try {
            return new String(Files.readAllBytes(Paths.get("src/test/java/Tasks/Task_15_RestAPI/Request/" + fileName + ".json")));
        } catch (IOException e) {
            e.printStackTrace();
        }
        return "";
